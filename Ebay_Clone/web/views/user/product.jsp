        ...
        <div class="product-content">
            ...
            <div class="filter-bar">
                <div class="view-options">
                    <button class="filter-button">All Listings</button>
                    <button class="filter-button">Auction</button>
                    <button class="filter-button">Buy It Now</button>
                </div>
                ...
                <div class="sort-list-style">
                    ...
                    <button class="list-style-button"><span class="material-icons">view_module</span></button>
                    <button class="list-style-button"><span class="material-icons">view_list</span></button>
                </div>
            </div>
            ...
            <div class="extra-filters">
                ...
                <select class="filter-dropdown">
                    <option>Maximum Resolution</option>
                </select>
                <select class="filter-dropdown">
                    <option>Type</option>
                </select>
